  ...
  <body> <!-- body부분 -->
    <form method=post action=server.php>
     <table border=1 width=500>
        ...
        <tr><td>아이디</td><td><input type=text name=myid required></td></tr>
        <tr><td>패스워드</td><td><input type=password name=mypw required></td></tr>
        <tr><td>패스워드(확인)</td><td><input type=password required></td></tr>
